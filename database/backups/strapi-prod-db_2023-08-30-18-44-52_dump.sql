...
INSERT INTO public.home_pages (id, greeting, created_at, updated_at, published_at, created_by_id, updated_by_id, vuid, version_number, version_comment, is_visible_in_list_view, locale, introduction_1, introduction_2, introduction_3, introduction_4, introduction_5) VALUES (2, 'Hey there, I''m Marta 👋🏻', '2023-08-30 12:49:33.677', '2023-08-30 16:24:45.559', '2023-08-30 12:50:15.289', 1, 1, '58f965d1-aa9a-4aa3-90cf-ccd11a8803af', 1, NULL, true, 'en', 'I''m a software engineer based in Turin, Italy, and I am currently working at {Resourcify}.', 'I hold a MSc in Advanced Computer Science from the University of Manchester, and have more than five years of work experience across several companies, including {BJSS} and {Booking}. ', 'My skill set embraces a range of programming languages, including Java, Kotlin, Python, C# and TypeScript, as well as frontend frameworks such as React and Angular.
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 181, true);
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 102, true);
