...
INSERT INTO public.code_snippets (id, code, language, created_at, updated_at, published_at, created_by_id, updated_by_id) VALUES (3, 'User marta = new User.Builder()
  .name("Marta Pancaldi")
  .role("Software Engineer")
  .build();
', 'Java', '2023-08-22 20:10:02.812', '2023-08-22 20:10:20.432', '2023-08-22 20:10:20.427', 1, 1);
...
></app-marta-pancaldi>', 'Angular', '2023-08-22 20:10:39.724', '2023-08-22 20:10:40.853', '2023-08-22 20:10:40.849', 1, 1);
...
INSERT INTO public.strapi_core_store_settings (id, key, value, type, environment, tag) VALUES (40, 'plugin_content_manager_configuration_content_types::api::code-snippet.code-snippet', '{"uid":"api::code-snippet.code-snippet","settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"language","defaultSortBy":"language","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"language":{"edit":{"label":"language","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"language","searchable":true,"sortable":true}},"code":{"edit":{"label":"code","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"code","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}}},"layouts":{"list":["id","language","createdAt"],"edit":[[{"name":"language","size":6}],[{"name":"code","size":12}]]}}', 'object', NULL, NULL);
...
INSERT INTO public.up_roles (id, name, description, type, created_at, updated_at, created_by_id, updated_by_id) VALUES (2, 'Public', 'Default role given to unauthenticated user.', 'public', '2023-08-13 18:13:24.195', '2023-08-22 20:00:21.313', NULL, NULL);
...
INSERT INTO public.video_games (id, title, year, link, created_at, updated_at, published_at, created_by_id, updated_by_id) VALUES (15, 'Ori and the Will of the Wisps', '2020', 'https://www.igdb.com/games/ori-and-the-will-of-the-wisps', '2023-08-23 16:19:24.205', '2023-08-23 16:21:43.79', NULL, NULL, 1);
...
SELECT pg_catalog.setval('public.admin_permissions_role_links_id_seq', 178, true);
...
SELECT pg_catalog.setval('public.code_snippets_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.files_folder_links_id_seq', 56, true);
...
SELECT pg_catalog.setval('public.files_id_seq', 77, true);
...
SELECT pg_catalog.setval('public.tv_shows_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.up_permissions_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.upload_folders_id_seq', 4, true);
