...
INSERT INTO public.home_pages (id, greeting, created_at, updated_at, published_at, created_by_id, updated_by_id, vuid, version_number, version_comment, is_visible_in_list_view, locale, introduction_1, introduction_2, introduction_3, introduction_4, introduction_5) VALUES (2, 'Hey there, I''m Marta ', '2023-08-30 12:49:33.677', '2023-10-21 19:09:53.042', '2023-08-30 12:50:15.289', 1, 1, '58f965d1-aa9a-4aa3-90cf-ccd11a8803af', 1, NULL, true, 'en', 'I''m a software engineer based in Turin, Italy, and I am currently working at {Resourcify}.', 'I hold a MSc in Advanced Computer Science from the University of Manchester, and have more than five years of work experience across several companies, including {BJSS} and {Booking}. ', 'My skill set embraces a range of programming languages like **Java**, **Kotlin**, **Python**, **C#** and **TypeScript**, as well as frontend frameworks such as **React** and **Angular**.
...
The article was written in collaboration between professors and associates of the faculties of Law and Computer Science of the Free University of Bolzano, and was accepted by IEEE for publication in the Nov/Dec 2018 issue.', 'cloud', '2018-04-01', 'university,gdpr,cloud', '{"article": "https://res.cloudinary.com/dwrurydlt/image/upload/v1692731283/IEEE_cb505789df.pdf", "publicUrl": "https://www.computer.org/csdl/magazine/cd/2018/06/mcd2018060058/17D45XwUAKp"}', '2023-09-10 10:40:32.028', '2023-10-21 17:55:12.234', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
For deployment and hosting, the website finds its home on **Vercel**.', 'nextjs,react,typescript,tailwind,graphql,strapi,vercel', '2023-07-01', 'personal,web,react', '{"github": "https://github.com/martapanc/martacodes.it", "publicUrl": "https://martacodes.it"}', '2023-10-21 18:34:43.266', '2023-10-22 08:30:00.951', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
This experience inspired my dissertation project, where I developed an automated testing tool for students'' coding exercises, aiming to streamline the instructor''s evaluation and grading tasks.', 'python', '2018-06-01', 'python,uni', '{"article": "https://res.cloudinary.com/dwrurydlt/image/upload/v1692731486/comp61511_msc_dissertation.pdf"}', '2023-10-21 16:40:43.516', '2023-10-21 16:40:45.107', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
A simple task, but a meaningful achievement and a fun way to apply coding skills to a real-life problem.', 'python', '2019-11-01', 'python,personal', '{"github": "https://github.com/martapanc/Zebra-Scraper"}', '2023-10-21 16:08:27.427', '2023-10-21 16:08:50.534', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
Our solution, winner of the contest between UniBZ and other Italian universities, was to create a brand for Glorenza and a consortium for the towns in the area - a brand to promote the history, the beauty of the landscapes and the tastiness of the food and that tourists get to know and trust.', 'java,android', '2014-12-31', 'java,android,uni,hackathon', '{"publicUrl": "http://hackmytown.unibz.it/"}', '2023-10-21 17:45:42.44', '2023-10-21 17:47:24.826', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
We built the UI in React, developing various components (a comparison of the available insurance options for the car details page, a few upsell banners and information sections) that we then integrated in the main webapp.', 'java,react,typescript,css', '2019-01-05', 'java,react,typescript,work,web', '{"screenshots": "https://res.cloudinary.com/dwrurydlt/image/upload/v1697892427/premium-screenshots.pdf"}', '2023-10-21 12:49:02.547', '2023-10-21 17:59:56.418', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
The research then analysed how such methods evolve from the moment the comment was introduced through Version Control and, based on the bugs reported in the code''s issue tracker, how the presence of technical debt affects the amount of bugs on average.', 'java', '2017-06-01', 'java,uni', '{"github": "https://github.com/martapanc/SATD-replication-package", "article": "https://res.cloudinary.com/dwrurydlt/image/upload/v1692731487/SATD_BSc_Thesis.pdf"}', '2023-10-21 16:46:53.368', '2023-10-21 16:47:24.524', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
INSERT INTO public.projects (id, title, short_description, long_description, tools, date, tags, links, created_at, updated_at, published_at, created_by_id, updated_by_id, vuid, version_number, version_comment, is_visible_in_list_view, locale) VALUES (19, 'Holiday request manager', 'Internship project: HMRS software with a versatile employee portal', 'I interned for three months at the [ICT Group](https://ict-group.it/en/) as a web developer, and my task was to build an additional feature to the company’s **HR management software**: a portal for the request and approval of the employee vacations, work permits, transfers and bank hours. 

The UI I developed consists of customisable calendars and timesheets, which offer different views according to the role of the logged user (employee or manager), and was built using **AngularJS** with the **Boostrap CSS** framework.', 'angular,nodejs,bootstrap,html,css,javascript', '2016-07-01', 'web,angular,work', '{"article": "https://res.cloudinary.com/dwrurydlt/image/upload/v1697909072/Internship_Final_Report.pdf"}', '2023-10-21 17:27:24.207', '2023-10-21 17:56:28.753', '2023-10-21 18:38:26.979', 1, 1, NULL, 1, NULL, true, 'en');
...
INSERT INTO public.strapi_core_store_settings (id, key, value, type, environment, tag) VALUES (17, 'plugin_upload_metrics', '{"weeklySchedule":"3 4 18 * * 1","lastWeeklyUpdate":1698084243069}', 'object', NULL, NULL);
...
SELECT pg_catalog.setval('public.files_folder_links_id_seq', 169, true);
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 515, true);
