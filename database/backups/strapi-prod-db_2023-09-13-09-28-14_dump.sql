...
INSERT INTO public.up_roles (id, name, description, type, created_at, updated_at, created_by_id, updated_by_id) VALUES (2, 'Public', 'Default role given to unauthenticated user.', 'public', '2023-08-13 18:13:24.195', '2023-09-13 07:27:17.832', NULL, NULL);
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 127, true);
