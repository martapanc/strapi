...
INSERT INTO public.files_related_morphs (id, file_id, related_id, related_type, field, "order") VALUES (119, 89, 1, 'api::project.project', 'image', 1);
...
INSERT INTO public.files_related_morphs (id, file_id, related_id, related_type, field, "order") VALUES (124, 90, 2, 'api::project.project', 'image', 1);
...
The article was written in collaboration between professors and associates of the faculties of Law and Computer Science of the Free University of Bolzano, and was accepted by IEEE for publication in the Nov/Dec 2018 issue.', 'cloud', '2018-11-01', 'university,gdpr,cloud', '{"article": "https://res.cloudinary.com/dwrurydlt/image/upload/v1692731283/IEEE_cb505789df.pdf", "publicUrl": "https://www.computer.org/csdl/magazine/cd/2018/06/mcd2018060058/17D45XwUAKp"}', '2023-09-10 10:40:32.028', '2023-09-10 16:08:50.326', '2023-09-10 10:40:34.971', 1, 1, NULL, 1, NULL, true, 'en');
...
The app has been downloaded 100000+ times and reached a rating of 4.3 during its lifetime. ', 'java,kotlin,android', '2018-06-01', 'java,kotlin,android,personal', '{"github": "https://github.com/martapanc/ItalianFiscalCodeCalculatorApp"}', '2023-09-10 10:22:46.831', '2023-09-10 19:29:23.366', '2023-09-10 10:40:34.971', 1, 1, NULL, 1, NULL, true, 'en');
...
INSERT INTO public.strapi_core_store_settings (id, key, value, type, environment, tag) VALUES (17, 'plugin_upload_metrics', '{"weeklySchedule":"43 28 18 * * 0","lastWeeklyUpdate":1694370523052}', 'object', NULL, NULL);
...
INSERT INTO public.up_roles (id, name, description, type, created_at, updated_at, created_by_id, updated_by_id) VALUES (2, 'Public', 'Default role given to unauthenticated user.', 'public', '2023-08-13 18:13:24.195', '2023-09-10 10:58:00.751', NULL, NULL);
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 189, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_links_id_seq', 199, true);
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 124, true);
...
SELECT pg_catalog.setval('public.up_permissions_role_links_id_seq', 35, true);
