...
INSERT INTO public.files_related_morphs (id, file_id, related_id, related_type, field, "order") VALUES (101, 1, 2, 'api::job.job', 'icon', 1);
INSERT INTO public.files_related_morphs (id, file_id, related_id, related_type, field, "order") VALUES (102, 1, 3, 'api::job.job', 'icon', 1);
...
INSERT INTO public.files_related_morphs (id, file_id, related_id, related_type, field, "order") VALUES (128, 94, 4, 'api::job.job', 'icon', 1);
...
INSERT INTO public.strapi_core_store_settings (id, key, value, type, environment, tag) VALUES (17, 'plugin_upload_metrics', '{"weeklySchedule":"48 53 17 * * 1","lastWeeklyUpdate":1695664428032}', 'object', NULL, NULL);
...
INSERT INTO public.uses_pages (id, created_at, updated_at, published_at, created_by_id, updated_by_id, vuid, version_number, version_comment, is_visible_in_list_view, locale) VALUES (1, '2023-09-26 14:04:32.814', '2023-09-27 09:10:04.795', '2023-09-27 09:10:04.786', 1, 1, NULL, 1, NULL, true, 'en');
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 220, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_links_id_seq', 230, true);
...
SELECT pg_catalog.setval('public.components_shared_titled_paragraphs_id_seq', 43, true);
...
SELECT pg_catalog.setval('public.files_folder_links_id_seq', 97, true);
...
SELECT pg_catalog.setval('public.files_id_seq', 100, true);
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 134, true);
...
SELECT pg_catalog.setval('public.podcasts_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.recruiters_pages_components_id_seq', 179, true);
...
SELECT pg_catalog.setval('public.recruiters_pages_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.recruiters_pages_localizations_links_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.uses_pages_components_id_seq', 40, true);
