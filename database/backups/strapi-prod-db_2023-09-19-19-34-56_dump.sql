...
INSERT INTO public.recruiters_pages (id, created_at, updated_at, published_at, created_by_id, updated_by_id, vuid, version_number, version_comment, is_visible_in_list_view, locale, intro, outro) VALUES (3, '2023-09-18 19:45:05.15', '2023-09-19 17:28:38.97', '2023-09-18 19:45:08.143', 1, 1, NULL, 1, NULL, true, 'en', 'I appreciate your interest in considering me for your software engineering positions. 
...
INSERT INTO public.strapi_core_store_settings (id, key, value, type, environment, tag) VALUES (17, 'plugin_upload_metrics', '{"weeklySchedule":"43 48 17 * * 1","lastWeeklyUpdate":1695059318029}', 'object', NULL, NULL);
...
INSERT INTO public.up_roles (id, name, description, type, created_at, updated_at, created_by_id, updated_by_id) VALUES (2, 'Public', 'Default role given to unauthenticated user.', 'public', '2023-08-13 18:13:24.195', '2023-09-18 18:16:24.645', NULL, NULL);
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 212, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_links_id_seq', 222, true);
...
SELECT pg_catalog.setval('public.components_shared_titled_paragraphs_id_seq', 38, true);
...
SELECT pg_catalog.setval('public.recruiters_pages_components_id_seq', 119, true);
...
SELECT pg_catalog.setval('public.up_permissions_role_links_id_seq', 37, true);
