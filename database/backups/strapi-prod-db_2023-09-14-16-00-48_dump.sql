...
- Support engineer/tester for the Platform team to create a containerised version of the client''s web-app', 'Software Engineer', 'BJSS', 'Manchester (remote)', '2023-08-21 19:19:11.572', '2023-09-13 19:47:24.72', '2023-08-21 19:19:18.961', 1, 1, 'en', '2020-11-02', '2022-03-01', false, '#1447BA', '#CEDCFA', '["PHP", "Drupal", "Java", "JavaScript", "Angular", "Vue", "Google Tag Manager", "Docker", "Jenkins", "Azure"]');
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 128, true);
